...
Source0  : https://files.pythonhosted.org/packages/cd/37/1b003190ba7148226a8212d98ff8074e212fef30c82e616bdb818ae1f838/zope.interface-6.2.tar.gz
...
%prep
%setup -q -n zope.interface-6.2
cd %{_builddir}/zope.interface-6.2
pushd ..
cp -a zope.interface-6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708101174
