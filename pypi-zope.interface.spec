...
Source0  : https://files.pythonhosted.org/packages/87/03/6b85c1df2dca1b9acca38b423d1e226d8ffdf30ebd78bcb398c511de8b54/zope.interface-6.1.tar.gz
...
%prep
%setup -q -n zope.interface-6.1
cd %{_builddir}/zope.interface-6.1
pushd ..
cp -a zope.interface-6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696520831
