...
Source0  : https://files.pythonhosted.org/packages/62/ba/e517891d44208f2a6cf493109dfff59134bb922a9c8bd2a896da7d9a82a1/zope.interface-5.5.0.tar.gz
...
%prep
%setup -q -n zope.interface-5.5.0
cd %{_builddir}/zope.interface-5.5.0
pushd ..
cp -a zope.interface-5.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665420806
